...
// https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/tutorials/nullable-reference-types#build-response-types
...
public class SurveyResponse(int id)
{
    ...
    public bool AnswerSurvey(IEnumerable<SurveyQuestion> questions)
    {
        if (ConsentToSurvey())
        {
            ...
            Console.WriteLine("User did not consent to the survey.");
